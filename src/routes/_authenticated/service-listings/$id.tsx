...
import { ShoppingBag, MapPin, Clock, Gavel, ChevronLeft } from "lucide-react";
...
import {
  buildSharedNavItems,
  SERVICE_LISTINGS_NAV_EXTRA,
} from "@/lib/shared-nav-items";
import {
...
function ServiceListingDetailPage() {
  ...
  const navItems = buildSharedNavItems(
