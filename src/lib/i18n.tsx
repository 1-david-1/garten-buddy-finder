...
const de: Dict = {
  ...
  "features.pro.body":
    "Mit Gewerbeschein & USt-IdNr. Kunden bekommen §35a EStG-fähige Rechnungen.",

  "marketplace.title": "Zwei Wege, Hilfe zu finden.",
  "marketplace.sub":
    "Egal ob du lieber ausschreibst oder sofort buchst — du entscheidest.",
  "marketplace.post.title": "Auftrag ausschreiben",
  "marketplace.post.body":
    "Beschreibe deinen Job in unter 60 Sekunden, erhalte Angebote von Helfern in deiner Nähe und wähle das beste aus.",
  "marketplace.browse.title": "Direkt buchen",
  "marketplace.browse.body":
    "Durchstöbere fertige Leistungsangebote — zum Festpreis, per Auktion oder verhandelbar. Sofort buchen, ohne zu warten.",
  "marketplace.browse.badge.fixed": "Festpreis",
  "marketplace.browse.badge.auction": "Auktion",
  "marketplace.browse.badge.negotiable": "Verhandelbar",

  "trust.title": "Sicher von Anfang bis Ende.",
  "trust.messaging.title": "Direkt chatten",
  "trust.messaging.body":
    "Fragen klären, Termine abstimmen — direkt in der App, ohne Telefonnummern auszutauschen.",
  "trust.reviews.title": "Bewertungen & Vertrauens-Score",
  "trust.reviews.body":
    "Jeder Helfer hat einen Vertrauens-Score aus echten Bewertungen früherer Aufträge — auf einen Blick erkennbar.",
  "trust.escrow.title": "Geld auf Treuhand",
  "trust.escrow.body":
    "Deine Zahlung wird erst freigegeben, wenn die Arbeit erledigt und bestätigt ist.",

  "flow.title": "So einfach geht's",
  "flow.1": "Auftrag posten",
  "flow.1.body":
    "Rasenmähen, Hecke schneiden, Unkraut jäten – in unter 60 Sekunden.",
  "flow.2": "Angebote erhalten",
  "flow.2.body":
    "Lokale Helfer bieten. Chat & Preis verhandeln direkt in der App.",
  ...
  "onboarding.role.helper_youth":
    "Ich bin 13–17 und möchte Taschengeld verdienen",
  "onboarding.role.helper_youth.desc": "Nach JArbSchG geschützt.",
  "onboarding.role.helper_adult":
    "Ich möchte in meiner Nachbarschaft helfen (18+)",
  ...
  "dashboard.helper.vacation.activeNoDate":
    "Aktiv, kein Rückkehrdatum hinterlegt",
  ...
  "dashboard.helper.pstg.sub":
    "Meldepflicht ab 25 Transaktionen oder 1.800 € Jahresumsatz.",
  "dashboard.helper.pstg.locked":
    "Auszahlungen pausiert – bitte Steuer-ID hinterlegen.",
  ...
  "dashboard.helper.error.body":
    "Bitte lade die Seite neu oder versuche es später erneut.",
  "dashboard.helper.error.generic":
  ...
  "admin.overview.auditPreview.empty":
...
const en: Dict = {
  ...
  "features.pro.body":
    "Registered business with VAT ID. Customers get tax-deductible invoices.",

  "marketplace.title": "Two ways to find help.",
  "marketplace.sub":
    "Whether you'd rather post a job or book instantly — it's your call.",
  "marketplace.post.title": "Post a job",
  "marketplace.post.body":
    "Describe your job in under a minute, get offers from helpers nearby, and pick the best one.",
  "marketplace.browse.title": "Book instantly",
  "marketplace.browse.body":
    "Browse ready-made service listings — fixed price, auction, or negotiable. Book right away, no waiting.",
  "marketplace.browse.badge.fixed": "Fixed price",
  "marketplace.browse.badge.auction": "Auction",
  "marketplace.browse.badge.negotiable": "Negotiable",

  "trust.title": "Safe from start to finish.",
  "trust.messaging.title": "Chat directly",
  "trust.messaging.body":
    "Clear up questions, agree on timing — right in the app, no phone numbers exchanged.",
  "trust.reviews.title": "Reviews & trust score",
  "trust.reviews.body":
    "Every helper has a trust score built from real reviews of past jobs — visible at a glance.",
  "trust.escrow.title": "Funds held in escrow",
  "trust.escrow.body":
    "Your payment is only released once the work is done and confirmed.",
