  ...
  head: () => ({
    meta: [
      { title: "GreenMatch — Gartenhilfe aus der Nachbarschaft" },
      {
        name: "description",
        content:
          "Marktplatz für Gartenhilfe im DACH-Raum: Auftrag ausschreiben oder fertige Angebote direkt buchen. Jugendliche, Nachbarn und Profi-Gärtner – JArbSchG-konform, mit Chat, Bewertungen, Treuhand & §35a-Rechnung.",
      },
      {
        property: "og:title",
        content: "GreenMatch — Gartenhilfe aus der Nachbarschaft",
      },
        ...
        <div className="relative overflow-hidden rounded-[2.85rem] bg-[#3a3a42] p-[10px]">
          ...
          <div className="relative overflow-hidden rounded-[2.4rem] border border-white/5 bg-background">
            ...
            <div className="aspect-[9/19.5] w-full bg-gradient-to-b from-emerald-soft to-transparent px-4 pb-5 pt-12">
              ...
              <div className="mb-3 font-brand text-lg text-primary">
                GreenMatch
              </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl border border-glass-border bg-glass p-8 backdrop-blur">
          ...
          <h3 className="mb-2 text-xl font-semibold">
            {t("marketplace.post.title")}
          </h3>
          <p className="text-sm text-muted-foreground">
            {t("marketplace.post.body")}
          </p>
        </div>
        <div className="rounded-3xl border border-glass-border bg-glass p-8 backdrop-blur">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary">
          ...
          <div className="flex flex-wrap gap-2 text-[11px]">
            <span className="inline-flex items-center gap-1 rounded-full border border-primary/30 bg-primary/10 px-2.5 py-1 text-primary">
              ...
              {t("marketplace.browse.badge.fixed")}
            </span>
            <span className="inline-flex items-center gap-1 rounded-full border border-primary/30 bg-primary/10 px-2.5 py-1 text-primary">
              <Gavel className="size-3" />
              {t("marketplace.browse.badge.auction")}
            </span>
            <span className="inline-flex items-center gap-1 rounded-full border border-primary/30 bg-primary/10 px-2.5 py-1 text-primary">
              <Handshake className="size-3" />
              {t("marketplace.browse.badge.negotiable")}
            </span>
          </div>
        </div>
      </div>
...
function Trust() {
  ...
  return (
    <section className="border-y border-glass-border bg-card/40 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {items.map(({ icon: Icon, key }) => (
            <div key={key} className="text-center">
              <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full border border-primary/40 bg-primary/10 text-primary">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {items.map((i) => (
          ...
          >
            ...
            <h3 className="mb-2 text-xl font-semibold">
              {t(`features.${i.key}.title`)}
            </h3>
            <p className="text-sm text-muted-foreground">
              {t(`features.${i.key}.body`)}
            </p>
          </div>
        ))}
      </div>
