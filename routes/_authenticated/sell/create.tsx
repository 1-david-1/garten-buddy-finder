...
function CreateListingPage() {
  ...
  // Vorab generierte ID, damit Fotos schon vor dem Speichern in den
  // richtigen Storage-Ordner hochgeladen werden können.
  ...
  const createMutation = useMutation({
    mutationFn: (publish: boolean) =>
      createFn({ data: { ...value, publish, id: draftId } }),
    onSuccess: (listing) => {
      toast.success(
